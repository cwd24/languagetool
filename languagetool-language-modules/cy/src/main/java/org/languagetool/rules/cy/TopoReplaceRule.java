 ...
 * USA
 */
package org.languagetool.rules.cy;

import org.languagetool.AnalyzedSentence;
import org.languagetool.AnalyzedTokenReadings;
import org.languagetool.JLanguageTool;
import org.languagetool.language.Welsh;
...
/**
 * A rule that matches place names in Welsh which should be
 * translated into Welsh.
 *
 * Loads the list of words from <code>rules/cy/topo.txt</code>.
 * This class is mostly copied from ro/SimplaceReplaceRules.java.
 * 
 * Based completely on the version for Breton, maybe this should
 * be a subclass.
 *
...
public class TopoReplaceRule extends Rule {
  ...
  public static final String WELSH_TOPO = "CY_TOPO";

  private static final String FILE_NAME = "/cy/topo.txt";
  private static final String FILE_ENCODING = "utf-8";
  // locale used on case-conversion
  private static final Locale CY_LOCALE = new Locale("cy");
  ...
  private final Tokenizer wordTokenizer = new Welsh().getWordTokenizer();
